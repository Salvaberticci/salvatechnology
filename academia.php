    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <main>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <!-- Card: Marca Personal (Coming Soon) -->
                <div class="glass-panel p-8 rounded-2xl border border-white/5 opacity-60 flex flex-col items-center text-center scale-95 grayscale">
                    ...
                    <h3 class="text-2xl font-bold mb-4 text-stone-300 italic">MARCA PERSONAL</h3>
                    <p class="text-stone-500 mb-6 flex-grow">Documentar tu proceso es la mejor estrategia de ventas. El código se vende a través de la confianza.</p>
                    <span class="px-6 py-2 border border-white/10 text-stone-500 rounded-full text-xs font-bold uppercase tracking-widest">Próximamente</span>
                </div>

                <!-- Card: Monetización (Coming Soon) -->
                <div class="glass-panel p-8 rounded-2xl border border-white/5 opacity-60 flex flex-col items-center text-center scale-95 grayscale">
                    <div class="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-stone-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-2xl font-bold mb-4 text-stone-300 italic">MONETIZACIÓN</h3>
                    <p class="text-stone-500 mb-6 flex-grow">Estrategias SaaS para generar ingresos recurrentes con tu software. Del proyecto a la empresa.</p>
                    <span class="px-6 py-2 border border-white/10 text-stone-500 rounded-full text-xs font-bold uppercase tracking-widest">Próximamente</span>
                </div>
            </div>
        </main>

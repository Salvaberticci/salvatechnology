    ...
    <div class="dashboard-layout">
        <aside class="dash-sidebar">
            ...
            <nav class="dash-nav">
                ...
                <a href="perfil">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>Mi Perfil</a>
                <a href="logout">
                ...
                <div class="catalog-card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($curso['precio'] > 0): ?>
                            <div class="price" style="color:#ff8c00;font-size:0.7rem;">🔒 REQUIERE SUSCRIPCIÓN</div>
                        <?php else: ?>
                            <div class="price free">GRATUITO</div>
                        <?php endif; ?>
                        <div class="desc"><?php echo htmlspecialchars(substr($curso['descripcion'] ?? '', 0, 150)) . (strlen($curso['descripcion'] ?? '') > 150 ? '...' : ''); ?></div>
                        ...
                        <?php if ($curso['ya_inscrito']): ?>
                            <a href="curso-info/<?php echo $curso['id']; ?>" class="btn-continuar" style="width:100%;justify-content:center;padding:0.7rem;font-size:0.8rem;">VER CURSO</a>
                        <?php else: ?>
                            <a href="curso-info/<?php echo $curso['id']; ?>" class="btn-explorar" style="width:100%;justify-content:center;padding:0.7rem;font-size:0.8rem;">VER DETALLES</a>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endforeach; ?>
